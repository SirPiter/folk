...
class AtsystemFeatureAbstract
{
	 ...
	 * @param AdmintoolsModelStorage        $componentParams   Component parameters
	 ...
	 */
	public function __construct($app, $db, JRegistry &$params, AdmintoolsModelStorage &$componentParams, JInput &$input, &$exceptionsHandler, array &$exceptions, &$skipFiltering)
	{
		$this->app = $app;
		$this->db = $db;
		$this->params = $params;
