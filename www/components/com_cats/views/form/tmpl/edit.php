...
JFactory::getLanguage()->load('com_cats', JPATH_ADMINISTRATOR.'/components/com_cats');
...
<form action="<?php echo JRoute::_('index.php?option=com_cats&a_id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate">
	<fieldset>
        ...
        <div class="formelm-buttons">
            <button type="button" onclick="Joomla.submitbutton('cat.save')">
                <?php echo JText::_('JSAVE') ?>
            </button>
            <button type="button" onclick="Joomla.submitbutton('cat.cancel')">
