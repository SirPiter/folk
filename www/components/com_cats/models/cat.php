 ...
 * @since 1.5
 */
class CatsModelCat extends JModelItem
{
	/**
	 ...
	 * @var		string
	 */
	protected $_context = 'com_cats.cat';
	...
	public function getItem($pk = null)
	{
		...
		if (!isset($this->_item[$pk])) {
			...
			try {
				...
				if (empty($data)) {
					return JError::raiseError(404,JText::_('COM_CATS_ERROR_CAT_NOT_FOUND'));
				}
