...
$baseUrl = F0FPlatform::getInstance()->isBackend() ? JUri::root().'administrator/' : JUri::root();
?>
<div class="ats-ticket-replyarea">
<form action="<?php echo $baseUrl ?>index.php?option=com_ats&view=bucket" method="post" id="adminForm" enctype="multipart/form-data">
