...
<?php endif;?>
	<div style="float: right;">
		<?php echo AtsHelperSelect::bucketstatuses($filter_status, 'filter-status', array('onchange'=>"document.getElementById('ats_filter_status').value = document.getElementById('filter-status')[document.getElementById('filter-status').selectedIndex].value;document.forms.atspagination.submit();"), 'filter-status') ?>
	</div>
</div>
