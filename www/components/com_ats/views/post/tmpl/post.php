...
// Let's the full list of allowed extensions from the Media Manager and make it unique
$allowedExt = array_unique(array_map('strtolower', explode(',', JComponentHelper::getParams('com_media')->get('upload_extensions'))));
