...
require_once JPATH_ROOT.'/administrator/components/com_ats/helpers/html.php';

AtsHelperHtml::keepalive();
...
<form name="ats_newticket_form" class="form-horizontal" action="<?php echo $actionURL ?>" method="post" onsubmit="ticketBeforeSubmit()" enctype="multipart/form-data">
	...
	<div class="control-group">
		...
		<div class="controls">
			...
			<a class="modal" style="display: none" id="userselect" href="index.php?option=com_ats&view=jusers&tmpl=component&field=created_by&category=<?php echo $this->category->id?>" rel="{handler: 'iframe', size: {x: 800, y: 500}}">Select</a>
		</div>
	</div>
	<?php endif; ?>
