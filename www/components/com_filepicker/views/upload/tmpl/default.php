...
?>
<form enctype="multipart/form-data" name="swfupload" action="index.php?option=com_filepicker&amp;view=upload&amp;tmpl=component" id="uploadform" method="POST">
<p><strong>Legal file extensions for uploading:</strong><?php echo $this->fileExtensions;?></p>
<p><input type="file" name="swffile" /></p>
<p><label for="overwriteId">Overrite existing files ? </label><input type="checkbox" name="overwrite" value="yes" id="overwriteId"/>
</p>
<p>
	<input name="swfuploaded" type="submit" value="upload" />
</p>
</form>