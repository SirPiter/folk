...
<div id="dirs">
<p><strong><?php echo JText::_('Change directory'); ?>: <?php echo $dirpathString;?></strong></p>
...
<div id="files">
<p>
	<strong><?php echo JText::_('Legal file extensions for viewing') ?>:</strong>&nbsp;<?php echo $this->fileTypes; ?></p>
...
<?php
	...
	foreach ($this->filesList as $file){
		...
		echo '<li><a href="javascript:setFile(\''.$file.'\');">'.$image.$file.'</a></li>';
	}
?>
</ul>
<?php 
}else{
	echo JText::_("No matching files in ").$this->displayDir.".";
}
?>
</div>
<br style="clear:both" />