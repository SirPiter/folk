...
class FilepickerViewUpload extends JView
{
	...
	{	
			...
			if ($check){
				...
				if ($doupload){
					if ( JFile::upload($src, $dest) ) {
						...
						$msg = "Error by copying file.".$src.' '.$dest;
					}
				}else{
		...
		$fileTypesArray = FilepickerParamHelper::getParamArray($validUploadFEString,array(),array(','));
		sort($fileTypesArray);
