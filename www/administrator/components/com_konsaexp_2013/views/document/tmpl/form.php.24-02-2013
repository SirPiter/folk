...
<div class="col100">
	<fieldset class="adminform">
		...
		<table class="admintable" border=0>
			...
			<td colspan="3">
				<input class="text_area" type="text" name="title" id="title" size="110" maxlength="250" value="<?php echo $this->doc->title;?>" />
			</td>
	</tr>
...
<input class="text_area" type="text" name="doc_path" id="doc_path" size="110" maxlength="250" value="<?php echo $this->doc->doc_path;?>" />
&nbsp 
