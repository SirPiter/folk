...
function stars(star_num,album_id){
	...
	for(var i = 1; i<6;i++){
		...
		document.getElementById("star" + i + "_" + album_id).src = "components/com_konsa_expl/assets/images/star" + grey + ".png";
...
try
  ...
  xmlHttp.open("GET","index2.php?option=com_konsa_expl&controller=albums&task=rate&points=" + points + "&album_id="+album_id,true);
  xmlHttp.send(null);
  }