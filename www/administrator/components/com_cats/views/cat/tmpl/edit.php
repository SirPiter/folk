...
<form action="<?php echo JRoute::_('index.php?option=com_cats&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="item-form" class="form-validate">
...
<?php if ($this->canDo->get('core.admin')): ?>
    <div class="width-100 fltlft">
        <?php echo JHtml::_('sliders.start','permissions-sliders-'.$this->item->id, array('useCookie'=>1)); ?>
            ...
            <?php echo JHtml::_('sliders.panel',JText::_('COM_CATS_FIELDSET_RULES'), 'access-rules'); ?>
