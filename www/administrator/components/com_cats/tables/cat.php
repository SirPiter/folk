 ...
 * cat Table class
 */
class CatsTableCat extends JTable
{
    /**
     * Constructor
     *
    ...
    {
        parent::__construct('#__cats', 'id', $db);
    }
    ...
    {
        if (trim($this->title) == '') {
            $this->setError(JText::_('COM_CATS_WARNING_PROVIDE_VALID_NAME'));
            return false;
        }
    ...
    public function store($updateNulls = false)
    {
        ...
        if ($this->id) {
            ...
            // New cat. An cat created and created_by field can be set by the user,
        ...
        $table = JTable::getInstance('Cat','CatsTable');
        if ($table->load(array('alias'=>$this->alias,'catid'=>$this->catid)) && ($table->id != $this->id || $this->id==0)) {
            $this->setError(JText::_('JLIB_DATABASE_ERROR_CAT_UNIQUE_ALIAS'));
            return false;
        }
