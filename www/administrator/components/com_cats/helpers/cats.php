...
class CatsHelper
{
	...
	public static function addSubmenu($vName = '')
	{
		...
		JSubMenuHelper::addEntry(
			JText::_('COM_CATS_TITLE_CATS'),
			'index.php?option=com_cats&view=cats',
			$vName == 'cats'
		);
		JSubMenuHelper::addEntry(
			JText::_('COM_CATS_SUBMENU_CATEGORIES'),
			'index.php?option=com_categories&extension=com_cats',
			$vName == 'categories');
	}
	...
	*/
	public static function filterText($text)
	{
		...
		$config		= JComponentHelper::getParams('com_cats');
		$user		= JFactory::getUser();
