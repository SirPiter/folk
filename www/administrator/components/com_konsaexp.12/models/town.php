...
class TownsModelTown extends JModel
{

	var $_towntype_list = null;
	...
	function getTownsData()
		{
			...
			if (empty( $this->_towns_data )){
				$query = 	' SELECT id,format_name FROM #__konsa_exp_towns '.
