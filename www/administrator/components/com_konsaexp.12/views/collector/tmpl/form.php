...
?>
  ...
  ?>
       ...
       <tr>
			<td width="100" align="right" class="key">
				<label for="greeting">
					<?php echo JText::_( 'Classification name' ); ?>:
				</label>
			</td>
			<td>
...
<td></td>
  ...
  <table class="admintable" border=0>
        ...
        <tr>
			<td width="100" align="right" class="key">
				<label for="greeting">
					<?php echo JText::_( 'Image for collector name' ); ?>:
				</label>
			</td>
			<td>
