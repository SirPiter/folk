...
?></td>
        ...
        <tr valign="middle">
			...
			<td valign="middle">
            <a rel="{handler: 'iframe', size: {x: 600, y: 530}}" onclick="IeCursorFix(); return false;"  href="<?php echo JRoute::_( 'index.php?option=com_filepicker&tmpl=component&e_name=soundfile') ?>" title="Filelink" class="modal-button"> <input type="submit" value="<?php echo JText::_( 'Browse' ); ?>" /></a>
          &nbsp;
