		...
		<tr class="thisform">
			<td width="100%" valign="top" class="thisform">
				<div id="cpanel">
					...
					<div class="icon-container">
						<div class="icon"> <a href="<?php echo JRoute::_('index.php?option=com_konsaexp&controller=docs') ?>" title="<?php echo JText::_('COM_KONSAEXP_C_DOCS_DESC');?>"> <img src="<?php echo JURI::base(true); ?>/components/com_konsaexp/media/icons/large/docs.png" align="middle" border="0" alt="" /> <span> <?php echo JText::_('COM_KONSAEXP_C_DOCS'); ?> </span></a> </div>
					</div>
					<div class="icon-container">
						<div class="icon"> <a href="<?php echo JRoute::_('index.php?option=com_konsaexp&controller=scans') ?>" title="<?php echo JText::_('COM_KONSAEXP_C_SCANS_DESC');?>"> <img src="<?php echo JURI::base(true); ?>/components/com_konsaexp/media/icons/large/scans.png"  align="middle" border="0" alt="" /> <span> <?php echo JText::_('COM_KONSAEXP_C_SCANS'); ?> </span></a> </div>
					</div>
					<div class="icon-container">
						<div class="icon"> <a href="<?php echo JRoute::_('index.php?option=com_konsaexp&controller=notes') ?>" title="<?php echo JText::_('COM_KONSAEXP_C_NOTES_DESC');?>"> <img src="<?php echo JURI::base(true); ?>/components/com_konsaexp/media/icons/large/notes.png"  align="middle" border="0" alt="" /> <span> <?php echo JText::_('COM_KONSAEXP_C_NOTES'); ?> </span></a> </div>
					</div>
                   	<div class="icon-container">
						<div class="icon"> <a href="<?php echo JRoute::_('index.php?option=com_konsaexp&controller=photos') ?>" title="<?php echo JText::_('COM_KONSAEXP_C_PHOTOS_DESC');?>"> <img src="<?php echo JURI::base(true); ?>/components/com_konsaexp/media/icons/large/photos.png" align="middle" border="0" alt="" /> <span> <?php echo JText::_('COM_KONSAEXP_C_PHOTOS'); ?> </span></a> </div>
					</div>
                   	<div class="icon-container">
						<div class="icon"> <a href="#" title="<?php echo JText::_('COM_KONSAEXP_C_HELP_DESC');?>"> <img src="<?php echo JURI::base(true); ?>/components/com_konsaexp/media/icons/large/phone.png" align="middle" border="0" alt="" /> <span> <?php echo JText::_('COM_KONSAEXP_C_HELP'); ?> </span></a> </div>
					</div>
