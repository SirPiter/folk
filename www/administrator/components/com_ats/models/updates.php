...
class AtsModelUpdates extends F0FUtilsUpdate
{
	...
	/**
	 * Performs an automatic update from the CLI
	 *
	 * @return array
	 */
...
ENDSUBJECT;
		...
		$email_body = <<<ENDBODY
This email IS NOT sent by the authors of Akeeba Ticket System. It is sent
automatically by your own site, [SITENAME]

================================================================================
UPDATE INFORMATION
================================================================================

Your site has determined that there is an updated version of Akeeba Ticket
...
ENDBODY;
	...
	private function getLastSend()
	{
		...
		return $params->get('ats_autoupdate_lastsend', 0);
	}
	...
	private function setLastSend()
	{
		...
		$params->set('ats_autoupdate_lastsend', time());
