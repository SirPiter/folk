 ...
 *
 */
class AtsModelStats extends F0FModel
{
	/**
	...
	public function checkAndFixCommonTables()
	{
		...
		$dbInstaller = new F0FDatabaseInstaller(array(
			'dbinstaller_directory' => JPATH_ADMINISTRATOR . '/components/com_ats/sql/common'
		));
	...
	public function collectStatistics($useIframe)
	{
		...
		if (!file_exists(JPATH_ROOT . '/administrator/components/com_ats/assets/stats/usagestats.php'))
		{
			return false;
		}
		...
		{
			require_once JPATH_ROOT . '/administrator/components/com_ats/assets/stats/usagestats.php';
		}
		...
		require_once JPATH_ROOT . '/administrator/components/com_ats/version.php';
		...
		$stats->setValue('sw', ATS_PRO ? 10 : 9); // software
		$stats->setValue('pro', ATS_PRO); // pro
