	...
	try
	  ...
	  xmlHttp.onreadystatechange=function()
		...
		if(xmlHttp.readyState==4)
		  {
			//we update the current playlist URL
			current_playlist_url = xmlHttp.responseText;
			current_encoded_playlist_url = urlencode(xmlHttp.responseText);
			// if the module player is loaded
	  ...
	  xmlHttp.open("GET","index2.php?option=com_muscol&task=set_current_playlist&id=" + id,true);
	  xmlHttp.send(null);
}
