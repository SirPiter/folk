...
class ExpeditionsViewPhonograms extends JView
{
	...
	//	$uri 		= & JFactory::getURI();
		...
		$this->_layout = $params->get('phonograms_view');
		 ...
		 */
                ...
                $lists['phon_filter_order_Dir'] = $state->get( 'phon_filter_order_Dir' );
                $lists['phon_filter_order']     = $state->get( 'phon_filter_order' );
