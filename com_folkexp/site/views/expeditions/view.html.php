...
class ExpeditionsViewExpeditions extends JView
{
	function display($tpl = null)
	{
    	...
    	$params =  & $app->getParams('com_konsaexp');
		...
		//echo "collectors_list : ";
		//print_r($collectors_list); // die;
        ...
        $lists['exp_filter_order_Dir'] = $state->get( 'exp_filter_order_Dir' );
        $lists['exp_filter_order']     = $state->get( 'exp_filter_order' );
 		$this->assignRef('lists', $lists);
		
// Создание списка собирателей		
		$collectors_list = & $this->get('CollectorsList');
//		$this->assignRef('collectors_list',	$collectors_list);
	 	$collectors[] = JHTML::_('select.option',  '0', JText::_('All collectors'), 'id', 'collector_full_name' );
