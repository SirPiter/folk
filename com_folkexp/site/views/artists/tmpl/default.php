...
<form action="index.php" method="get" title="<? echo JText::_('Artists list'); ?>" name="adminForm">

<h1><? echo JText::_('Artists list'); ?></h1>
<table  align="left">
	<tr>
		<td width="100%">
		<?php echo JText::_( 'Search' ); ?>: 
		<input type="text" name="keywords" id="keywords" value="<?php echo $this->keywords;?>" class="text_area" size="40" maxlength="255" /> &nbsp;<button onclick="document.adminForm.limitstart.value=0; submitform();return false;"><?php echo JText::_( 'Search Artists' ); ?></button>

 <? if ($this->keywords) { ?>
    &nbsp;
<button onclick="document.getElementById('artist_keys').value='';document.getElementById('keywords').value='';this.form.getElementById('keywords').value='0';this.form.getElementById('keywords').value=''; this.form.getElementById('artist_keys').value='0';this.form.getElementById('artist_keys').value='';document.adminForm.limitstart.value=0;this.form.submit();"><?php echo JText::_( 'All Artists' ); ?></button>
    <? } ?>
    <hr />
		</td>
	</tr>
     ...
     <table class="adminlist" width="100%">
		...
		<tr>
			<th>
                ...
                <?php echo JHTML::_( 'grid.sort', 'Artist fullname', 'artist_full_name', $this->lists['col_filter_order_Dir'], $this->lists['col_filter_order']); ?>
			</th>
            <th align="center">
...
//	$link_exp= JRoute::_( 'index.php?option=com_konsaexp&view=expedition&id='. $row->id  );
	$link_call= JRoute::_( 'index.php?option=com_konsaexp&view=artist&id='. $row->id  );
	 ?>
    <tr>
		<td  style='padding-left:5px;'>
		          <a class='llista_artista' style='width:100%;' href='<?php echo $link_call; ?>' title="Полное имя">
					 <?php echo $row->artist_full_name; ?></a>
        </td>
        <td  style='padding-left:5px;'>
...
?>
    ...
    <input type="hidden" name="artist_keys"  id="artist_keys" value=""/><br />
